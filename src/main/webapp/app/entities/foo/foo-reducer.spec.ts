...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './foo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOO_LIST actions', async () => {
    ...
    it('dispatches FETCH_FOO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOO actions', async () => {
      const expectedActions = [
        {
